...
const shopOrder = {
  ...
  getPriceSum() {
    let result = 0;
    //menu 안에 있는 product price의 총 합.
    for (const food in shopOrder.menu) {
      if (Object.prototype.hasOwnProperty.call(shopOrder.menu, food)) {
        const element = shopOrder.menu[food];
...
console.log(shopOrder.getPriceSum());
// 메서드와 this
